...
test("create and read Post", async () => {
  await runScenario(async scenario => {
    ...
    // Bob gets the Authors for the new Post
...
test("create and delete Post", async () => {
  await runScenario(async scenario => {
    ...
    // Bob gets the Authors for the Post again
